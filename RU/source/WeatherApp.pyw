...
class WeatherApp(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.owm = OWM('6d00d1d4e704068d70191bad2673e0cc', language='ru')
    ...
    def showWeather(self):
        try:
            ...
            self.ui.label.setText('Обработка запроса...')
            self.repaint()
            ...
            self.ui.label.setText('Температура: {0} °C \
                                  \nВетер: {1} м/с \
                                  \nПогода:\n{2} \
                                  \nЗавтра:\n{3} \
                                  \nПослезавтра:\n{4}'.format(
            ...
            self.ui.label.setText('Произошла сетевая\nошибка!')
        except exceptions.api_response_error.NotFoundError:
            self.ui.label.setText('Вы ввели неверное\nназвание города!')
        except exceptions.api_call_error.APICallError:
            self.ui.label.setText('Произошла ошибка\nпри обработке запроса!')
